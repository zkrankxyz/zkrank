/**
 *Submitted for verification at Optimistic.Etherscan.io on 2023-07-26
*/
...
contract UniversalONFT721 is ONFT721 {
    ...
    function mint() external payable {
        require(nextMintId <= maxMintId, "zkVoter: max mint limit reached");
...
contract zkVoter is UniversalONFT721 {
    constructor(uint256 _minGasToStore, address _layerZeroEndpoint, uint _startMintId, uint _endMintId) UniversalONFT721("zkVoter", "Voter", _minGasToStore, _layerZeroEndpoint, _startMintId, _endMintId) {}
}